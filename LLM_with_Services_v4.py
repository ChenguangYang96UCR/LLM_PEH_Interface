        ...
        if response.choices:
            ...
            if service_type and zipcode:
                try:
                    ...
                    st.write("In Year 2023, the Number of Crime Incidents in Zipcode " + zipcode + ":",
                             str(number_of_crimes))
                    st.write("In Year 2023, the Frequencies of Different Crime Incidents in Zipcode are as follows " + zipcode + ":",
                        str(crime_frequency))
