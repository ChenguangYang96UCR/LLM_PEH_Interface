            ...
            try:
                ...
                if classified_service_type != "Other":
                    ...
                    if not location_info.empty:
                        ...
                        geolocation_query = "Just list the their names with comma. Please find only five famous buildings or benchmarks near the location: latitidue: 39.978, longitude: -75.1459"
